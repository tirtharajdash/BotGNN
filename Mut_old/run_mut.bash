...
#path settings
prefixdir="/home/dell5810/tdash/prepareBotGraph/Mut/processed"
trntstsplitdir="/home/dell5810/tdash/prepareBotGraph/Mut/mut_splits"


#create the directory where the Results will be stored
resultdir="Result_BotGNN5_Mut"
...
do
	...
	python main_mut.py --dataset BOTDS
