...
#path settings
prefixdir="/home/dell5810/tdash/prepareBotGraph/Choline/processed_type"
trntstsplitdir="/home/dell5810/tdash/prepareBotGraph/Choline/choline_splits"


#create the directory where the Results will be stored
resultdir="Result_BotGNN5_Choline_type"
...
do
	...
	python main_choline.py --dataset BOTDS
