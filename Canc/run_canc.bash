...
#path settings
prefixdir="/home/dell5810/tdash/prepareBotGraph/Canc/processed"
trntstsplitdir="/home/dell5810/tdash/prepareBotGraph/Canc/canc_splits"


#create the directory where the Results will be stored
resultdir="Result_BotGNN4_Canc_type"
...
do
	...
	python main_canc.py --dataset BOTDS
