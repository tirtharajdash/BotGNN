...
#path settings
prefixdir="/home/dell5810/tdash/prepareBotGraph/Toxic/processed_type"
trntstsplitdir="/home/dell5810/tdash/prepareBotGraph/Toxic/toxic_splits"


#create the directory where the Results will be stored
resultdir="Result_BotGNN4_Toxic_type"
...
do
	...
	python main_toxic.py --dataset BOTDS
