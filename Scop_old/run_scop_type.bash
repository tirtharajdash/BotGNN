...
#path settings
prefixdir="/home/dell5810/tdash/prepareBotGraph/Scopolamine/processed_type"
trntstsplitdir="/home/dell5810/tdash/prepareBotGraph/Scopolamine/scop_splits"


#create the directory where the Results will be stored
resultdir="Result_BotGNN1_Scop_type"
...
do
	...
	python main_scop.py --dataset BOTDS
