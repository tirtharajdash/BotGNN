...
#path settings
prefixdir="/home/dell5810/tdash/prepareBotGraph/DssTox/processed_more"
trntstsplitdir="/home/dell5810/tdash/prepareBotGraph/DssTox/dsstox_splits"


#create the directory where the Results will be stored
resultdir="Result_BotGNN4_DssTox_more"
...
do
	...
	python main_dsstox.py --dataset BOTDS
